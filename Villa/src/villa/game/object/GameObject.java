...
public class GameObject
{
	 ...
	 * Sets the position of the object.
	 * 
	 * @param pos the position you want the object to be at
	 */
	...
	public final void setCollision(boolean isSolid)
	{
	...
	/**
	 * End update used for such things like clearing information that is required during the update but should not be carried onto the next cycle.
	 */
